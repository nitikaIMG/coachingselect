    ...
    <div class="card-body">
        <div class="sbp-preview">
            <div class="sbp-preview-content">
                <form action="{{ action('TestimonialsController@edit_testimonial') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    $image = asset('public/testimonials/'. $testimonial->image);
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="stars" placeholder="Enter Stars" value="{{$testimonial->stars}}" required maxlength="3" onkeyup="return is_correct_stars()" onkeypress="return isNumberKey(event)">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="country" id="country_id" class="form-control selectpicker show-tick" data-width="full" data-container="body" data-live-search="true" required>
                                        ...
                                        <option value="{{$country->name}}"
                                            @if($country->name == $testimonial->country)
                                            selected
                                            @endif
                                        >{{$country->name}}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="state" id="state_id" class="form-control selectpicker show-tick" data-width="full" data-container="body" data-live-search="true" required>
                                        ...
                                        <option value="{{$state->name}}"
                                            @if($state->name == $testimonial->state)
                                            selected
                                            @endif
                                        >{{$state->name}}</option>
                                        @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    id="description"
                                     class="form-control ckeditor" required placeholder="Enter description">{{$testimonial->description}}</textarea>
                                </div>
                            </div>
