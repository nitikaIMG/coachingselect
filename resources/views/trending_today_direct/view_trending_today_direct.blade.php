...
@section('sub-heading')
View Trending Today Direct
@endsection('sub-heading')

@section('card-heading-btn')
<a href="{{action('TrendingTodayDirectController@add_trending_today_direct')}}" class="btn btn-sm btn-light font-weight-bold text-uppercase text-primary float-right" data-toggle="tooltip" title="" data-original-title="Add Trending Today Direct"><i class="fas fa-plus"></i>&nbsp; Add</a>
                ...
                <form action="" method="get" id="search">
                    ...
                    <div class="form-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto align-self-end">
                                <a href="{{action('TrendingTodayDirectController@view_trending_today_direct')}}" class="btn btn-sm my-3 btn-warning text-uppercase"><i class="far fa-undo"></i>&nbsp; Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="card">
    <div class="card-header">View Trending Today Direct</div>
    <div class="card-body">

        <div class="datatable table-responsive">
            <table class="table table-bordered table-striped table-hover text-nowrap" id="view_trending_today_direct_dt" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th class="text-align-center" width="50">
                            S. No</th>
                        <th>
                            Trending Today Direct Title</th>
                        <th>
                            URL</th>
                        <th>
                            Created At</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#view_trending_today_direct_dt').DataTable({
            "processing": true,
            "serverSide": true,

            "ajax": {
                "url": "<?php echo action('TrendingTodayDirectController@view_trending_today_direct_dt'); ?>?name=" + name+ '&start_date=' + start_date + '&end_date=' + end_date,
                "datatype": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}"
        ...
        $("#view_trending_today_direct_dt_length").hide();
        $("#view_trending_today_direct_dt_filter").hide();
    });
</script>
