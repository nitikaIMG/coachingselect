...
@include('alert_msg')
<div class="card">
    <div class="card-header">Edit Enterprise</div>
    <div class="card-body">
        <div class="sbp-preview">
            <div class="sbp-preview-content">
                <form action="{{ action('EnterpriseController@edit_enterprise') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row align-items-center">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter Name" value="{{$blog->name}}" required>
                                </div>
                            </div>
