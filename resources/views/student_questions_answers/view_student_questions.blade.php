                ...
                <form action="" method="get" id="search">
                    ...
                    <div class="form-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto align-self-end">
                                <a href="{{action('StudentQuestionsAnswersController@view_student_questions')}}" class="btn btn-sm my-3 btn-warning text-uppercase"><i class="far fa-undo"></i>&nbsp; Reset</a>
                            </div>
...
<div class="card">
    <div class="card-header">View Student Questions</div>
    <div class="card-body">

        <div class="datatable table-responsive">
            <table class="table table-bordered table-striped table-hover text-nowrap" id="view_student_questions_dt" width="100%" cellspacing="0">
                <thead>
                    <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#view_student_questions_dt').DataTable({
            'bFilter': false,
            "processing": true,
            "serverSide": true,
            "searching": false,
            "ajax": {
                "url": "<?php echo action('StudentQuestionsAnswersController@view_student_questions_dt'); ?>?name=" + name + "&mobile=" + mobile+ '&start_date=' + start_date + '&end_date=' + end_date,
                "datatype": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}"
