    ...
    function () {
            ...
            function(index, element){
                ...
                if( this.value != '' && this.value != 'on' ){
                    ...
                    if( permissions.includes(this.value) ){
                        $(this).parent().find('.custom-control-label').removeClass('custom-control-label');
                        $(this).parent().removeClass('custom-control');
                        $(this).parent().removeClass('custom-switch');
                ...
                // console.log(
                //     $('input[type="checkbox"]').length + ' ' + (index + 1)
                // );
        ...
        $('input[name="selectall"]').each(
            function (index, element) {
                ...
                if($('input[name="selectall"]').length == (index + 1)) {
                    $('#preloader_admin').hide();
                } else {
                    $('#preloader_admin').show();
                }
