    ...
    <div class="card-body">
        <div class="sbp-preview">
            <div class="sbp-preview-content">
                <form action="{{ action('CoursesController@edit_course',$getCourse->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <?php
                    $stream_id = "";
                    ...
                    <input type="hidden" name="oldName" value="{{ $getCourse->name }}">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <select name="stream_id" data-width="full" data-container="body" data-live-search="true" id="stream_id" class="form-control selectpicker show-tick" required>
                                        ...
                                        <option value="{{$stream->id}}" @if($stream->id == $getCourse->stream_id)
                                            selected
                                            @endif
                                            >{{$stream->name}}</option>
                                        @endforeach
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <select name="type" data-width="full" data-container="body" data-live-search="true" id="type" class="form-control selectpicker show-tick" required>
                                        ...
                                        <option value="coaching" @if($getCourse->type=='coaching') selected @endif >Coaching</option>
                                        <option value="college" @if($getCourse->type=='college') selected @endif >College</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter Course Name" required value="{{ $getCourse->name }}">
