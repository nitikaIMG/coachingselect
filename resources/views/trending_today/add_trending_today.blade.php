...
<a href="{{action('TrendingTodayController@view_trending_today')}}" class="btn btn-sm btn-light font-weight-bold text-uppercase text-primary float-right" data-toggle="tooltip" title="" data-original-title="View All Trending Today"><i class="fad fa-eye"></i>&nbsp; View</a>
...
<div class="card">
    <div class="card-header">Add Trending Today</div>
    <div class="card-body">
        <div class="sbp-preview">
            <div class="sbp-preview-content">
                <form action="{{ action('TrendingTodayController@add_trending_today') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Enter Trending Today Title" required>
                                </div>
                            </div>
