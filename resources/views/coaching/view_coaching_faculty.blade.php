...
<a href="{{action('CoachingController@add_faculty', 'id=' . $coaching_id)}}" class="btn btn-sm btn-light font-weight-bold text-uppercase text-primary float-right mx-1" data-toggle="tooltip" title="" data-original-title="Add Faculty"><i class="fas fa-plus"></i>&nbsp; Add Faculty</a>
                ...
                <form action="" method="get" id="search">
                    ...
                    <div class="form-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto align-self-end">
                                <a href="{{action('CoachingController@view_coaching_faculty')}}?id={{$coaching_id}}" class="btn btn-sm my-3 btn-warning text-uppercase"><i class="far fa-undo"></i>&nbsp; Reset</a>
                            </div>
...
<div class="card">
    <div class="card-header">View Coaching ("{{ $coaching_name }}") Faculty</div>
    <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#allmatches_datatable').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo action('CoachingController@view_coaching_faculty_dt'); ?>?name=" + name + "&mobile=" + mobile+ '&start_date=' + start_date + '&end_date=' + end_date,
                "datatype": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}",
