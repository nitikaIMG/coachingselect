...
<a href="{{action('CoachingController@add_videos', 'id=' . $coaching_id)}}" class="btn btn-sm btn-primary mx-1" data-toggle="tooltip" title="" data-original-title="Add Videos"><i class="fas fa-plus"></i>&nbsp; Add Videos</a>
...
<div class="card">
    <div class="card-header">View Coaching ("{{ $coaching_name }}") Videos</div>
    <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#allmatches_datatable').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo action('CoachingController@view_coaching_videos_dt'); ?>?name=" + name + "&mobile=" + mobile,
                "datatype": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}",
