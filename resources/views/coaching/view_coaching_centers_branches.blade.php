...
<a href="{{action('CoachingController@add_branch', 'id=' . $coaching_id)}}" class="btn btn-sm btn-primary mx-1" data-toggle="tooltip" title="" data-original-title="Add Branch"><i class="fas fa-plus"></i>&nbsp; Add Branch</a>
                ...
                <form action="" method="get" id="search">
                    ...
                    <div class="form-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto align-self-end">
                                <a href="{{action('CoachingController@view_coaching_centers_branches')}}?id={{$coaching_id}}" class="btn btn-sm my-3 btn-warning text-uppercase"><i class="far fa-undo"></i>&nbsp; Reset</a>
                            </div>
...
<div class="card">
    <div class="card-header">View Coaching ("{{ $coaching_name ?? ''}}") Centers Branch</div>
    <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#allmatches_datatable').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo action('CoachingController@view_coaching_centers_branches_dt'); ?>?name=" + name + "&mobile=" + mobile+ '&start_date=' + start_date + '&end_date=' + end_date,
                "datatype": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}",
...
<!-- google location -->
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?libraries=places&key={{ config('app.GOOGLE_MAPS_API_KEY') }}"></script>
