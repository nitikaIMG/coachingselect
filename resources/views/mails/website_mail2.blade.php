<table cellspacing="0" cellpadding="0" dir="ltr" border="1" style="table-layout:fixed;font-size:10pt;font-family:Calibri;border-collapse:collapse;border:none;width:100%">
   <colgroup>
      <col width="88">
      <col width="256">
      <col width="46">
   ...
   <tbody>
      ...
      <tr style="height:110;vertical-align: middle;">
      ...
      <tr style="height:17px">
         ...
         <td style="border-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:0px 3px;vertical-align:top;font-family:Arial;font-size:9pt;color:rgb(0,0,0);text-align:center" rowspan="1" colspan="2">
            1
         </td>
      ...
      <tr style="height:104px">
         ...
         <td style="border-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0) rgb(204,204,204);overflow:hidden;padding:0px 3px;vertical-align:top;font-family:Arial;font-size:9pt" rowspan="1" colspan="5"><span style="font-size:9pt">Total :  {{ $my_purchase->total ?? '' }}
         <br/>
         ...
         @endif
         <br></span><span style="font-size:9pt;font-weight:bold">Grand Total : {{ $my_purchase->total_price ?? '' }}                                    </span></td>
      </tr>
      ...
      <tr style="height:110px;border-width:1px;border-style:solid;border-color:rgb(204,204,204) rgb(0,0,0) rgb(0,0,0);overflow:hidden;padding:0px 3px;vertical-align:top;font-family:Arial;font-size:8pt;border-top: 0px;">
         <td  rowspan="1" colspan="7" style="border: 0px;">
            ...
            <span style="font-size:8pt;display: grid;">
               3. All Rights Reserved to CoachingSelect.<br>4. Any Dispute is subject to Jaipur jurisdiction only.<br>
            </span>
         </td>   
         <td  rowspan="1" colspan="7" style="border:0px;text-align:right;vertical-align:bottom;padding-top: 15px;padding-bottom: 15px;">
            
               <div style=""><img src="{{ asset('public/authrise_sign.png') }}" alt="image.png" width="64" height="31" style="font-size:8pt;" data-image-whitelisted="" class="CToWUd"> <br>
