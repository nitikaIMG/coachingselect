...
<div class="card">
    <div class="card-header">Add College Category</div>
    <div class="card-body">
        <div class="sbp-preview">
            <div class="sbp-preview-content">
                <form action="{{ action('CollegeCategoryController@add_college_category') }}" method="post" enctype="multipart/form-data">
                    @csrf
